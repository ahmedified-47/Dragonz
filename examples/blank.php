    ...
    <section class="content">
     ...
     <div class="card">
          <div class="card-header">
            <h3 class="card-title" style="font-size: 20px; font-weight: bold;">Product Details</h3>
          ...
          <div class="card-body">
            <button type="button" id="insert" class="btn btn-success btn-md">Insert</button>
            <table class="table table-dark table-bordered table-hover table-stripped text-center">
              <tr>
                <th>ID</th>
                <th>Image</th>
                <th>Product Name</th>
            ...
            <div class="moda_body">
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="discounted_price" name="discounted_price" aria-describedby="emailHelp" required>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Category(Product Description)</label>
                  <input type="text" class="form-control" id="category" name="category" aria-describedby="emailHelp" required>
                </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="submit" id="save" value="submit" class="btn btn-primary">Save changes</button>
              </div>
            </div>
          </div>
        </div>
